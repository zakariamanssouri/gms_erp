...
// class AddCustomerOrderPage extends StatelessWidget {
//   CustomerOrder? customer_order;
//   AddCustomerOrderPage({
//     Key? key,
//     this.customer_order,
//   }) : super(key: key);
//   @override
...
//       this.customer_order = CustomerOrder(id: '', customerNo: '', customerOrderNo: '', receiptNo: '');
//     return AddingWidget(customer_order: customer_order!);
//   }
// }
...
//   bool? update;
//   final CustomerOrder customer_order;
...
//           elevation: 0,
//           title: update! ? Text(
//             "Commande  " + customer_order.receiptNo!,
//             style: TextStyle(
//                 color: Colors.black,
...
//                   text: 'La commande a été ajouté avec succès',
//                 );
...
//                 inventory: null,
//                 button_function: () {
//                   DataField(customer_order: customer_order, isUpdate: update!);
//                 },
//               );
//                     }
//                    }, // Error
//                    child: DataField(customer_order: customer_order, isUpdate: update!)
//             ),
//           )]),
//           )
//           ),
...
//   final CustomerOrder customer_order;
//   final bool isUpdate;
//   DataField({Key? key, required this.customer_order, required this.isUpdate})
//       : super(key: key);

//   @override
//   State<DataField> createState() =>
//       DataFieldState(customer_order, isUpdate);
// }
