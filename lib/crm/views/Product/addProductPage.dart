          ...
          ExpansionTile(
              ...
              // data is loaded
                  ...
                  BlocProvider.of<ProductBloc>(context).add(
                      ...
                      return ProductSecondDataField(product: product, isUpdate: update!);
                     } // Error
            ),
          ),
                )
...
class ProductSecondDataField extends StatefulWidget {
  final Product product;
  bool isUpdate;
  ProductSecondDataField({Key? key, required this.product, required this.isUpdate})
      : super(key: key);

  @override
  State<ProductSecondDataField> createState() =>
      ProductSecondDataFieldState(product, isUpdate);
}

class ProductSecondDataFieldState extends State<ProductSecondDataField> {
  Product product;
  bool isUpdate;
  ...
  ProductSecondDataFieldState(this.product, this.isUpdate) {
    if(isUpdate){
