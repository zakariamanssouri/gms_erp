...
import 'views/CustomerDeliveryOrder/customer_delivery_order.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        routes: {
          ...
          '/CustomerInvoices': (context) => CustomerInvoices(),
          '/CustomerDeliveryOrders': (context) => const CustomerDeliveryOrderPage(),
        },
        title: 'GM-CRM',
        theme: ThemeData(
